...
use bytebuf::{deserializer, serializer, ReadingError};
...
impl TryFrom<VarInt> for ClientIntent {
...
pub trait Packet: PacketId + Sized {
...
impl<P> Packet for P
where
    P: PacketId + Serialize + DeserializeOwned,
{
